...
//dijkstra只適用於undirected or directed 且 weight > 0
//Bellan-Ford 可用於 negative weight -> 有點類似 "brute solution" 
//每次都嘗試relax所有邊，直到有一次sweep沒有relax到其中一個edge為止
//🆘如果sweep的次數大於 the number of nodes -> 有 negative weight cycle ! -> return -1
#include <iostream>
#include <vector>
using namespace std;
